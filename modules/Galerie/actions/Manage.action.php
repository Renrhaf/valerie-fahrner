...
/**
 * Gestion des images d'une galerie
 ...
 */
final class Manage extends Action{
    
    private $method_name = 'manage';
    private $display_name = 'gérer les images';
